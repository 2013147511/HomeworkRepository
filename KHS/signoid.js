...
function signoidReady(){
    ...
    alert('선택된 옵션 text 값=' + myMajor.options[myMajor.selectedIndex].text); 
    document.getElementById("readyre").innerText = "12"+mymajor.options[mymajor.selectedIndex].value +"11";
}
